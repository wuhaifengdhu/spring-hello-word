...
public class UserData {
    ...
    public void setUserfeedback(String userfeedback) {
        this.userfeedback = userfeedback == null ? null : userfeedback.trim();
    }
    ...
    public void setAirvelocity(String airvelocity) {
        this.airvelocity = airvelocity == null ? null : airvelocity.trim();
    }
    ...
    public void setMeanradianttemp(String meanradianttemp) {
        this.meanradianttemp = meanradianttemp == null ? null : meanradianttemp.trim();
    }
    ...
    public void setMetabolicrate(String metabolicrate) {
        this.metabolicrate = metabolicrate == null ? null : metabolicrate.trim();
    }
    ...
    public void setClothinglevel(String clothinglevel) {
        this.clothinglevel = clothinglevel == null ? null : clothinglevel.trim();
    }
    ...
    public void setAmbientlight(String ambientlight) {
        this.ambientlight = ambientlight == null ? null : ambientlight.trim();
    }
    ...
    public void setUvleveldata(String uvleveldata) {
        this.uvleveldata = uvleveldata == null ? null : uvleveldata.trim();
    }
    ...
    public void setAccelerationx(String accelerationx) {
        this.accelerationx = accelerationx == null ? null : accelerationx.trim();
    }
    ...
    public void setAccelerationy(String accelerationy) {
        this.accelerationy = accelerationy == null ? null : accelerationy.trim();
    }
    ...
    public void setAccelerationz(String accelerationz) {
        this.accelerationz = accelerationz == null ? null : accelerationz.trim();
    }
    ...
    public void setFlightsascended(String flightsascended) {
        this.flightsascended = flightsascended == null ? null : flightsascended.trim();
    }
    ...
    public void setFlightsdescended(String flightsdescended) {
        this.flightsdescended = flightsdescended == null ? null : flightsdescended.trim();
    }
    ...
    public void setSteppinggain(String steppinggain) {
        this.steppinggain = steppinggain == null ? null : steppinggain.trim();
    }
    ...
    public void setSteppingloss(String steppingloss) {
        this.steppingloss = steppingloss == null ? null : steppingloss.trim();
    }
    ...
    public void setStepsascended(String stepsascended) {
        this.stepsascended = stepsascended == null ? null : stepsascended.trim();
    }
    ...
    public void setStepsdescended(String stepsdescended) {
        this.stepsdescended = stepsdescended == null ? null : stepsdescended.trim();
    }
    ...
    public void setCalorytoday(String calorytoday) {
        this.calorytoday = calorytoday == null ? null : calorytoday.trim();
    }
    ...
    public void setDistancetoday(String distancetoday) {
        this.distancetoday = distancetoday == null ? null : distancetoday.trim();
    }
    ...
    public void setCurrentpace(String currentpace) {
        this.currentpace = currentpace == null ? null : currentpace.trim();
    }
    ...
    public void setCurrentspeed(String currentspeed) {
        this.currentspeed = currentspeed == null ? null : currentspeed.trim();
    }
    ...
    public void setCurrentmontiontype(String currentmontiontype) {
        this.currentmontiontype = currentmontiontype == null ? null : currentmontiontype.trim();
    }
    ...
    public void setAngularvelocityx(String angularvelocityx) {
        this.angularvelocityx = angularvelocityx == null ? null : angularvelocityx.trim();
    }
    ...
    public void setAngularvelocityy(String angularvelocityy) {
        this.angularvelocityy = angularvelocityy == null ? null : angularvelocityy.trim();
    }
    ...
    public void setAngularvelocityz(String angularvelocityz) {
        this.angularvelocityz = angularvelocityz == null ? null : angularvelocityz.trim();
    }
    ...
    public void setSteptoday(String steptoday) {
        this.steptoday = steptoday == null ? null : steptoday.trim();
    }
    ...
    public void setRrinterval(String rrinterval) {
        this.rrinterval = rrinterval == null ? null : rrinterval.trim();
    }
    ...
    public void setSkintemp(String skintemp) {
        this.skintemp = skintemp == null ? null : skintemp.trim();
    }
}